...
<section className="relative">
  <div className="bg-[url('https://images.unsplash.com/photo-1583337130417-3346a1be7dee?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')] bg-cover bg-center h-[500px] relative">
    <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
      <div className="text-center text-white px-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Éducation canine et comportementaliste</h1>
        <h2 className="text-2xl md:text-3xl mb-6">Vaison la Romaine - Vaucluse - Drôme</h2>
        <p className="text-xl mb-8 max-w-2xl mx-auto">Éducation positive et bienveillante pour votre chiot ou chien</p>
  ...
  <div className="container mx-auto px-4">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
        <img src="https://images.unsplash.com/photo-1548199973-03cce0bbc87b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="Préparation à l'arrivée du chiot" className="w-full h-48 object-cover" />
        <div className="p-6">
